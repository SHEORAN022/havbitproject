...
// const couponRoutes = require("./routes/couponRoutes");
// const vendorOrderRoutes = require("./routes/vendorOrderRoutes");
// const parcelxRoutes = require("./parcelx/parcelx.routes");
...
// Add these lines in your app.js routes section:

/* VENDOR WAREHOUSE MANAGEMENT */
app.use('/api/vendor/warehouse', require('./routes/vendorWarehouse.routes'));
app.use('/api/orders', require('./routes/customerOrder.routes'));
/* PARCELX INTEGRATION */
app.use('/api/parcelx', require('./routes/parcelx.routes'));
/* ADMIN */
app.use("/api/admin/vendors", require("./routes/adminVendor"));
app.use("/api/admin/customers", require("./routes/adminCustomerRoutes"));
app.use("/api/vendor/inventory", require("./routes/inventoryRoutes"));

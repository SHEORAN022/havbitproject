...
//       address_title: address_title || `${vendor.businessName} Warehouse`,
...
//       success: true,
//       data: {
//         hasWarehouse: !!vendor.warehouse?.parcelxWarehouseId,
//         warehouse: vendor.warehouse || null,
...
//       .select('name businessName email phone warehouse isParcelxIntegrated parcelxLastSync')
//       .sort({ createdAt: -1 });
    
//     const stats = {
//       total: vendors.length,
//       withWarehouse: vendors.filter(v => v.warehouse?.parcelxWarehouseId).length,
//       withoutWarehouse: vendors.filter(v => !v.warehouse?.parcelxWarehouseId).length,
...
//         email: v.email,
//         phone: v.phone,
//         hasWarehouse: !!v.warehouse?.parcelxWarehouseId,
//         warehouseId: v.warehouse?.parcelxWarehouseId,
//         warehouseCity: v.warehouse?.city,
